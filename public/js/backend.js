...
__webpack_require__(/*! bootstrap.native/dist/bootstrap-native-v4.min.js */ "./node_modules/bootstrap.native/dist/bootstrap-native-v4.min.js");

var backendSidebar = document.querySelector('#backend-sidebar');
var userMenu = document.querySelector('#user-menu');
var hamburgerNavBtn = document.querySelector('.hamburger-nav'); // Toggle Hamburger Nav Btn

hamburgerNavBtn.addEventListener('click', function () {
  hamburgerNavBtn.classList.toggle('is-active');
});
hamburgerNavBtn.addEventListener('click', function (e) {
...
__webpack_require__(/*! C:\laragon\www\atbookingsystem\resources\js\backend.js */"./resources/js/backend.js");
module.exports = __webpack_require__(/*! C:\laragon\www\atbookingsystem\resources\sass\backend.scss */"./resources/sass/backend.scss");

<nav id="backend-navigation" class="custom-bg-dark custom-shadow">
  <div class="nav">
    {{--  --}}
    <div class="hamburger hamburger--collapse-r hamburger-nav" id="sidebar-toggler">
...
<div id="user-menu" class="custom-bg-dark custom-shadow">
	...
	<hr class="m-0">
	<a href="{{ route('backend.logout') }}" onclick="event.preventDefault(); document.querySelector('#backend-logout-form').submit();"><i class="fas fa-sign-out-alt"></i><span>{{ __('Sigh Out') }}</span></a>
